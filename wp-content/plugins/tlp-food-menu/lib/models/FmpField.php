...
if ( ! class_exists( 'FmpField' ) ):
	class FmpField {
		...
		private function imageSize() {
			...
			$h        = null;
			$h        .= "<div class='rt-image-size-holder rt-multiple-field-container'>";
			$h        .= "<div class='rt-inner-field rt-col-3 rt-image-size-width rt-image-size'>";
			$h        .= "<label>Width</label>";
			$h        .= "<input type='number' name='{$this->name}[width]' value='{$width}' />";
			$h        .= "</div>";
			$h        .= "<div class='rt-inner-field rt-col-3 rt-image-size-height rt-image-size'>";
			$h        .= "<label>Height</label>";
			$h        .= "<input type='number' name='{$this->name}[height]' value='{$height}' />";
			$h        .= "</div>";
			$h        .= "<div class='rt-inner-field rt-col-3 rt-image-size-crop rt-image-size'>";
			$h        .= "<label>Crop</label>";
