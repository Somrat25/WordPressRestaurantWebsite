...
if ( ! class_exists( 'FmOptions' ) ) :
	...
	class FmOptions {
		...
		public function scLayout() {
			$layouts = array(
				'layout-free'      => __( 'Layout', 'tlp-food-menu' ),
				'grid-by-cat-free' => __( 'Grid By Category', 'tlp-food-menu' ),
			);
		...
		function proFeature() {
			return $feature = "<ol>
					...
					<p></p><a href='https://www.radiustheme.com/tlp-food-menu-wordpress/' class='button button-primary' target='_blank'>Get Pro Version</a><p></p>";
		}
